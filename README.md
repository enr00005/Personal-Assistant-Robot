...
| :--- | :--- | :--- |
| **Audio (I2S)** | Data Out (DOUT) <br>Bit Clock (BCLK) <br>Word Select (LRCK) | GPIO 25 <br>GPIO 27 <br>GPIO 26 |
| **L298N Motors** | Left Motor (ENA, IN1, IN2) <br>Right Motor (ENB, IN3, IN4) | GPIO 13, 12, 15 <br>GPIO 14, 32, 33 |
| **Line Sensors** | Front Left / Right IR <br>Back Left / Right IR | GPIO 18, 19 <br>GPIO 16, 17 |
| **Tray & Distance** | Food/Plate IR Sensor <br>Ultrasonic (TRIG / ECHO) | GPIO 23 <br>GPIO 5 / GPIO 4 |
